...
public class FstepServicesClientIT {
    ...
    public void setUp() throws Exception {
        ...
        FstepQueueService queueService = mock(FstepQueueService.class);
        FstepServiceLauncher fstepServiceLauncher = new FstepServiceLauncher(workerFactory, jobDataService,dataBasketDataService, guiService, catalogueService, costingService, securityService, queueService);
