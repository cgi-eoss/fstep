...
@Table(name = "fstep_credentials",
        indexes = {@Index(name = "fstep_credentials_host_idx", columnList = "host")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"host"})})
@NoArgsConstructor
@Entity
public class DownloaderCredentials implements FstepEntity<DownloaderCredentials> {
