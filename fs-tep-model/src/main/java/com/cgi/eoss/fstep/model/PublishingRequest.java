...
@Table(name = "fstep_publishing_requests",
        indexes = {@Index(name = "fstep_publishing_requests_owner_idx", columnList = "owner")},
        uniqueConstraints = {@UniqueConstraint(name = "fstep_publishing_requests_owner_object_idx", columnNames = {"owner", "type", "associated_id"})})
@NoArgsConstructor
@Entity
public class PublishingRequest implements FstepEntityWithOwner<PublishingRequest> {
    /**
     ...
     * the {@link FstepService#id} for {@link Type#SERVICE}.</p>
     */
