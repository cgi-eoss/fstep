...
@Table(name = "fstep_wallet_transactions",
        indexes = {@Index(name = "fstep_wallet_transactions_wallet_idx", columnList = "wallet")})
@NoArgsConstructor
@Entity
public class WalletTransaction implements FstepEntityWithOwner<WalletTransaction> {
    /**
    ...
    /**
     * <p>The ID of the associated action, e.g. the {@link Job#id} for {@link Type#JOB} or the {@link FstepFile#id} for
    ...
    public enum Type {
        CREDIT(null), JOB(Job.class), DOWNLOAD(FstepFile.class), JOB_PROCESSING(JobProcessing.class), SUBSCRIPTION(Subscription.class);
