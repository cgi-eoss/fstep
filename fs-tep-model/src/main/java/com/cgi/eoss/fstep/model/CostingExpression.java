...
@Table(name = "fstep_costing_expressions",
        indexes = {@Index(name = "fstep_costing_expressions_type_associated_id_idx", columnList = "type, associated_id")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"type", "associated_id"})})
@NoArgsConstructor
@Entity
public class CostingExpression implements FstepEntity<CostingExpression> {
    ...
    /**
     * <p>The ID of the associated entity, e.g. the {@link FstepService#id} for {@link Type#SERVICE} or the {@link
