...
public class HttpDownloader implements Downloader {
    ...
    @Autowired
    public HttpDownloader(FstepServerClient fstepServerClient, OkHttpClient okHttpClient, DownloaderFacade downloaderFacade) {
        this.fstepServerClient = fstepServerClient;
        this.client = okHttpClient.newBuilder()
                .authenticator(new FstepAuthenticator())
    ...
    private final class FstepAuthenticator implements Authenticator {
