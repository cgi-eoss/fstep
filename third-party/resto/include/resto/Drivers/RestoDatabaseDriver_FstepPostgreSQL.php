...
require_once __DIR__.'/PostgreSQL/Fstep_Functions_features.php';
require_once __DIR__.'/PostgreSQL/Fstep_Functions_filters.php';
 ...
 */
class RestoDatabaseDriver_FstepPostgreSQL extends RestoDatabaseDriver_PostgreSQL {
    ...
    public function get($typeName, $params = array()) {
        switch ($typeName) {
            ...
            case parent::FEATURE_DESCRIPTION:
                $featuresFunctions = new Fstep_Functions_features($this, __DIR__.'/../../fstep_config.php');
