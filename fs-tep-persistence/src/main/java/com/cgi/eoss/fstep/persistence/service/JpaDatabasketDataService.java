...
import com.cgi.eoss.fstep.persistence.dao.DatabasketDao;
...
import static com.cgi.eoss.fstep.model.QDatabasket.databasket;
...
public class JpaDatabasketDataService extends AbstractJpaDataService<Databasket> implements DatabasketDataService {
    ...
    @Override
    FstepEntityDao<Databasket> getDao() {
        return dao;
    }
    ...
    @Override
    public List<Databasket> findByFile(FstepFile file) {
