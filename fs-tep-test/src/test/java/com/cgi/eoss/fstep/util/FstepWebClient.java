...
public class FstepWebClient {
    ...
    private final FstepHarness harness;
    private final OkHttpClient httpClient;

    public FstepWebClient(FstepHarness fstepHarness) {
        harness = fstepHarness;
    ...
    public void load(FstepPage page) {
        load(page.getUrl());
    }
    ...
    public void openPanel(FstepPanel panel) {
    ...
    public void click(FstepClickable button) {
    ...
    public void enterText(FstepFormField formField, String input) {
    ...
    private String getUrl(String path) {
        return harness.getFstepBaseUrl() + path;
    }
