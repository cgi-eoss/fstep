...
public class ZooManagerTestConfig {
    ...
    @Bean
    public Path zcfgBasePath(@Value("${fstep.zoomanager.zcfg.path:/var/www/cgi-bin}") String zcfgBasePath) throws IOException {
    ...
    @Bean
    public Path zooServicesStubJar(@Value("${fstep.zoomanager.stub.jarFile:/var/www/cgi-bin/jars/fs-tep-services.jar}") String zooServicesStubJar) throws IOException {
