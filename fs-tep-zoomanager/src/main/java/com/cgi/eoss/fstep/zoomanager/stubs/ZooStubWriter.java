...
/**
 * <p>Utility to generate ZOO-Project WPS service implementations from {@link FstepServiceDescriptor} objects.</p>
 */
@FunctionalInterface
public interface ZooStubWriter {
     ...
     */
    void generateWpsStubLibrary(Set<FstepServiceDescriptor> services, Path jar);
