...
import com.cgi.eoss.fstep.zoomanager.ZooManagerConfig;
import com.cgi.eoss.fstep.zoomanager.zcfg.ZcfgWriter;
import com.cgi.eoss.fstep.zoomanager.zcfg.ZcfgWriterImpl;
...
public class CliYamlToZcfg {
    ...
    private static final YamlFstepServiceDescriptorHandler YAML = new YamlFstepServiceDescriptorHandler();
    ...
    public static void main(String[] args) {
        ...
        FstepServiceDescriptor svc = YAML.readFile(inputYaml);
