...
public abstract class RestoSearchProvider implements SearchProvider {
    ...
    public SearchResults search(SearchParameters parameters) throws IOException {
        ...
        LOG.info("Submitting Resto search: {}", request.url());
    ...
    protected abstract Map<String, SearchResults.Link> getLinks(HttpUrl requestUrl, SearchResults.Page page, RestoSearchResult restoResult);
