package com.cgi.eoss.fstep.api.security.dev;
...
@ConditionalOnProperty(value = "fstep.api.security.mode", havingValue = "DEVELOPMENT_BECOME_ANY_USER")
public class BecomeAnyUser {

    private final String usernameRequestAttribute;
    private final UserDataService userDataService;

    public BecomeAnyUser(@Value("${fstep.api.security.username-request-attribute:REMOTE_USER}") String usernameRequestAttribute, UserDataService userDataService) {
