...
@RepositoryRestResource(
        ...
        itemResourceRel = "userPreference",
        collectionResourceRel = "userPreferences",
        excerptProjection = ShortUserPreference.class)
public interface UserPreferencesApi extends BaseRepositoryApi<UserPreference>, PagingAndSortingRepository<UserPreference, Long>, UserPreferencesApiCustom {
