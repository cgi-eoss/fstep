...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('DeveloperManageServiceCtrl', ['$scope', 'ProductService', 'ProductTemplateService', 'UserMountsService', 'CommonService', '$mdDialog', function ($scope, ProductService, ProductTemplateService, UserMountsService, CommonService, $mdDialog) {
