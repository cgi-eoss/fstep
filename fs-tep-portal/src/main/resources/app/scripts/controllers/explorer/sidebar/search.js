...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('SearchbarCtrl', ['$scope', '$rootScope', '$http', 'CommonService', 'BasketService', 'GeoService', 'MapService', 'SearchService', function ($scope, $rootScope, $http, CommonService, BasketService, GeoService, MapService, SearchService) {
        ...
        $scope.selectDataSource = function (dataSource) {
            ...
            if (dataSource.id === 3) {
                ...
                $scope.searchParametersV2.repo = 'FSTEP_PRODUCTS';
            } else {
