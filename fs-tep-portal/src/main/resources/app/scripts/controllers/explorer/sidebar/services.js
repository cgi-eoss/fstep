/**
 * @ngdoc function
 * @name fstepApp.controller:ServicesCtrl
 * @description
 * # ServicesCtrl
...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('ServicesCtrl', ['$scope', '$rootScope', '$sce', 'ProductService', 'TabService', function ($scope, $rootScope, $sce, ProductService, TabService) {
