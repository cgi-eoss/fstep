/**
 * @ngdoc function
 * @name fstepApp.controller:ResultsCtrl
 * @description
 * # ResultsCtrl
...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('ResultsCtrl', [ '$scope', '$rootScope', '$anchorScroll', '$timeout', 'GeoService', 'SearchService', 'TabService', function($scope, $rootScope, $anchorScroll, $timeout, GeoService, SearchService, TabService) {
