/**
 * @ngdoc function
 * @name fstepApp.controller:BottombarCtrl
 * @description
 * # BottombarCtrl
...
define(['../../../fstepmodules'], function (fstepmodules) {
    fstepmodules.controller('BottombarCtrl', [ '$scope', '$rootScope', '$q', 'CommonService', 'TabService', 'BasketService', 'JobService', 'SearchService', 'FileService', 'MessageService', '$mdDialog', function($scope, $rootScope, $q, CommonService, TabService, BasketService, JobService, SearchService, FileService, MessageService, $mdDialog) {
