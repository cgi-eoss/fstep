/**
 * @ngdoc function
 * @name fstepApp.controller:CommunityManageServiceCtrl
 * @description
...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('CommunityManageServiceCtrl', ['CommunityService', 'ProductService', '$scope', function (CommunityService, ProductService, $scope) {
