/**
 * @ngdoc function
 * @name fstepApp.controller:CommunityManageGroupCtrl
 * @description
...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('CommunityManageGroupCtrl', ['CommunityService', 'GroupService', 'UserService', '$scope', '$mdDialog', function (CommunityService, GroupService, UserService, $scope, $mdDialog) {
