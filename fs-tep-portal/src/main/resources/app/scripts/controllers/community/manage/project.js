/**
 * @ngdoc function
 * @name fstepApp.controller:CommunityManageProjectCtrl
 * @description
...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('CommunityManageProjectCtrl', ['CommunityService', 'ProjectService', '$scope', '$mdDialog', function (CommunityService, ProjectService, $scope, $mdDialog) {
