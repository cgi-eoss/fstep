...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('CommunityManageDatabasketCtrl', ['BasketService', 'FileService', 'CommunityService', '$scope', '$mdDialog', function (BasketService, FileService, CommunityService, $scope, $mdDialog) {
