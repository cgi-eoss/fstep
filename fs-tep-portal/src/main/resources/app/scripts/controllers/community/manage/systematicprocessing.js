...
define(['../../../fstepmodules', 'ol', 'clipboard'], function (fstepmodules, ol, clipboard) {

    fstepmodules.controller('CommunityManageSystematicProcessingCtrl', ['CommunityService', 'SystematicService', 'AoiService', 'MapService', 'CommonService', 'MessageService', '$scope', '$location', function (CommunityService, SystematicService, AoiService, MapService, CommonService, MessageService, $scope, $location) {
