/**
 * @ngdoc function
 * @name fstepApp.controller:CommunityProjectsCtrl
 * @description
...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('CommunityProjectsCtrl', ['ProjectService', 'CommonService', '$scope', function (ProjectService, CommonService, $scope) {
