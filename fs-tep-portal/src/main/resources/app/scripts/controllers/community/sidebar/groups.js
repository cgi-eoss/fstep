/**
 * @ngdoc function
 * @name fstepApp.controller:CommunityGroupsCtrl
 * @description
 * # CommunityGroupsCtrl
...
define(['../../../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.controller('CommunityGroupsCtrl', ['GroupService', 'CommonService', '$scope', function (GroupService, CommonService, $scope) {
