/**
 * @ngdoc service
 * @name fstepApp.EstimateCostService
 * @description
 * # EstimateCostService
...
define(['../fstepmodules', 'traversonHal' ], function(fstepmodules, TraversonJsonHalAdapter) {
    ...
    fstepmodules.service('EstimateCostService', ['fstepProperties', '$q', 'traverson', '$mdDialog', 'MessageService', 'CommonService', function(fstepProperties, $q, traverson, $mdDialog, MessageService, CommonService) {
