...
define(['../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.service('GeoService', ['$http', '$rootScope', 'fstepProperties', '$q', 'MessageService', 'MapService', function ($http, $rootScope, fstepProperties, $q, MessageService, MapService) {
        ...
        this.getGeoResults = function (pageNumber) {
            ...
            $http({
                method: 'GET',
                url: fstepProperties.URL + '/search',
                params: params,
