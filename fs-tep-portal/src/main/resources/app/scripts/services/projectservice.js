...
define(['../fstepmodules', 'traversonHal'], function (fstepmodules, TraversonJsonHalAdapter) {
    ...
    fstepmodules.service('ProjectService', [ 'fstepProperties', 'MessageService', 'CommunityService', 'UserService', 'traverson', '$q', '$rootScope', '$timeout', function (fstepProperties, MessageService, CommunityService, UserService, traverson, $q, $rootScope, $timeout) {
