...
define(['../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.service('CommonService', ['$rootScope', 'fstepProperties', '$mdDialog', '$q', '$injector', function ($rootScope, fstepProperties, $mdDialog, $q, $injector) {
