...
define(['../fstepmodules', 'traversonHal'], function (fstepmodules, TraversonJsonHalAdapter) {
    ...
    fstepmodules.service('UserService', [ 'fstepProperties', '$rootScope', '$q', 'MessageService', 'traverson', '$mdDialog', '$window', '$timeout', function (fstepProperties, $rootScope, $q, MessageService, traverson, $mdDialog, $window, $timeout) {
        ...
        this.checkLoginStatus = function() {
            halAPI.from(fstepProperties.URLv2 + '/users/current')
            .newRequest()
            .getResource()
            .result
            .then(function (user) {
