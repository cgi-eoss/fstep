...
define(['../fstepmodules', 'traversonHal'], function (fstepmodules, TraversonJsonHalAdapter) {
    ...
    fstepmodules.service('UserService', [ 'fstepProperties', '$rootScope', '$q', 'MessageService', 'traverson', '$mdDialog', '$window', function (fstepProperties, $rootScope, $q, MessageService, traverson, $mdDialog, $window) {
