...
define(['../fstepmodules', 'traversonHal'], function (fstepmodules, TraversonJsonHalAdapter) {
    ...
    fstepmodules.service('GroupService', [ 'fstepProperties', '$q', 'UserService', 'MessageService', 'TabService',  'CommunityService', 'traverson', '$timeout', '$rootScope', function (fstepProperties, $q, UserService, MessageService, TabService, CommunityService, traverson, $timeout, $rootScope) {
