...
define(['../fstepmodules', 'traversonHal'], function(fstepmodules, TraversonJsonHalAdapter) {
    ...
    fstepmodules.service('BasketService', ['$rootScope', '$http', 'fstepProperties', '$q', '$timeout', 'MessageService', 'UserService', 'TabService', 'CommunityService', 'FileService', 'traverson', function($rootScope, $http, fstepProperties, $q, $timeout, MessageService, UserService, TabService, CommunityService, FileService, traverson) {
        ...
        function getBasketItemLink(item, itemLinks) {
            ...
            if (item._links && item._links.self) {
                ...
                FileService.createGeoResultFile(item).then(function(fstepFile) {
                    itemLinks.push(fstepFile._links.self.href);
                    partialPromise.resolve();
                }, function(error) {
