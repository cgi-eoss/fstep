/**
 * @ngdoc service
 * @name fstepApp.CommunityService
 * @description
 * # CommunityService
...
define(['../fstepmodules'], function (fstepmodules) {
    ...
    fstepmodules.service('CommunityService', ['fstepProperties', 'MessageService', '$http', '$q',  function (fstepProperties, MessageService, $http, $q) {
