...
TRAINING_OUTPUT_CLASSIFICATION_MODEL="${OUT_DIR}/model/FSTEP_LANDCOVERS2_${TIMESTAMP}_training_model.txt"
TRAINING_OUTPUT_CONFUSION_MATRIX_CSV="${OUT_DIR}/confusionMatrix/FSTEP_LANDCOVERS2_${TIMESTAMP}_confusion_matrix.csv"
OUTPUT_FILE="${OUT_DIR}/result/FSTEP_LANDCOVERS2_${TIMESTAMP}.tif"
